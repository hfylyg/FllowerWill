<?php
/* Smarty version 3.1.30, created on 2018-01-18 08:05:00
  from "D:\Desktop\www\Flower\template\index\typecontent.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5a60552c9e0917_47080458',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ac0711162aa0fe2940ec553bde99affe53017349' => 
    array (
      0 => 'D:\\Desktop\\www\\Flower\\template\\index\\typecontent.html',
      1 => 1516262699,
      2 => 'file',
    ),
  ),
...
function content_5a60552c9e0917_47080458 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
<head>
...
type-back.png" alt=""></a>
		<div class="title">
			<div class="headertitle">领导</div>
			<div class="descbox">
				<div class="heng"></div>
				<div class="desc">给你的事业加点助力</div>
				<div class="heng"></div>
			</div>
		</div>
	</div>
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide list-group">
						<div class="list-group-item">
							<a href='index.php?a=content' class="mainbox">
								<div class="mainimg"><img src="<?php echo IMG_PATH;?>
listimg.png" alt=""></div>
								<div class="maincontent">
									<div class="ct1">
										<div class="mainname">鹤望兰</div>
										<div class="star"></div>
									</div>
									<div class="ct2">对前方阻碍不屈不挠</div>
									<div class="ct3">
										<div class="fang"></div>
										<div class="heng1"></div>
										<div class="fang"></div>
...
list-zan.png" alt=""></div>
											<div class="number">232433</div>
										</div>
										<div class="enjoy">
											<div href="" class="enyimg"><img src="<?php echo IMG_PATH;?>
list-fenxiang.png" alt=""></div>
											<div class="number">67563</div>
										</div>
									</div>
								</div>
...
list-fenxiang.png" alt=""></div>
						...
						<div class="list-group-item">列表c</div>
						<div class="list-group-item">列表d</div>
						<div class="list-group-item">列表</div>
						<div class="list-group-item">列表</div>
					</div>
				</div>
...
<?php echo '<script'; ?>
 src="<?php echo JS_PATH;?>
jquery-3.0.0.min.js" type="text/javascript" charset="utf-8"><?php echo '</script'; ?>
>
<?php echo '<script'; ?>
 src="<?php echo JS_PATH;?>
